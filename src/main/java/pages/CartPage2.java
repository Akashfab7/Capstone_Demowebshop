...
public class CartPage2 extends BaseTest {
   ...
   //login purpose
    ...
    //Locating the shoppipng cart link
    public By shoppingcart = By.linkText("Shopping cart");
    
    // what ever we have to do the changes rom here
    ...
    public By shoes1 = By.linkText("Apparell & Shoes");
    //public By cellphones = By.linkText("Cell phones");
    public By firstproducts = By.xpath("//div[@class='page-body']//div[2]//div[1]//div[2]//div[3]//div[2]//input[1]");
